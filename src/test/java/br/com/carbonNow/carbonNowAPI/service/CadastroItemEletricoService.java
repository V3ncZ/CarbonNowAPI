...
public class CadastroItemEletricoService {
    ...
    public Response cadastrarItemEletrico(Object itemEletricoCadastroDto, String endpoint) {
        String token = Hook.getToken();
        return RestAssured
                .given()
                .contentType(ContentType.JSON)
                .header("Authorization", "Bearer " + token)
                .body(itemEletricoCadastroDto)
                .when()
    ...
    public Response excluirItemEletrico(Long id) {
        String token = Hook.getToken();
        return RestAssured
                .given()
                .contentType(ContentType.JSON)
                .header("Authorization", "Bearer " + token)
                .when()
                .delete(BASE_URL + "/deletarItemEletrico/" + id)
                .then()
                .extract()
                .response();
    }
    ...
    public void setContract(String contract) throws IOException, JSONException {
        switch (contract) {
            case "Cadastro de item eletrico bem sucedido" -> jsonSchema = loadJsonFromFile(schemasPath + "cadastro-item-eletrico-schema.json");
